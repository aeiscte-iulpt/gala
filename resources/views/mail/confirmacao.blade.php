...
<head>
    ...
    * {
    ...
    [style*="Albert Sans"] {
        font-family: 'Albert Sans', BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif !important;
    }
    ...
    @media only screen and (min-width: 481px) {
        ...
        .t28 {
            padding: 48px 50px 48px 53px !important
        }
                                            ...
                                            <table role=presentation width=100% cellpadding=0 cellspacing=0>
                                                            ...
                                                            <tr>
                                                                <td class=t84
                                                                    ...
                                                                    <div style="font-size:0px;"><img class=t90
                                                                            ...
                                                                            width=130 src=https://gala.aeiscte-iul.pt/img/Logo Dourado AE.png /></div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td class=t104
                                                                    ...
                                                                    <p class=t110
                                                                        ...
                                                                        A inscrição foi registada com sucesso. Por favor
                                                                        dirige-te à secretaria da AEIscte para
                                                                        procederes ao pagamento. Confirma o teu registo:
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr>
                                                    <td>
                                                        <p class=t120
                                                            ...
                                                            <b>Nome da mesa:</b> {{$data['nome_mesa']}}</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <p class=t130
                                                            style="font-family:BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif, 'Albert Sans';line-height:22px;font-weight:500;font-style:normal;font-size:14px;text-decoration:none;text-transform:none;letter-spacing:-0.56px;direction:ltr;color:#333333;text-align:center;mso-line-height-rule:exactly;mso-text-raise:2px;">
                                                            <b>Nome do responsável:</b> {{$data['nome1']}}</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <p class=t220
                                                            style="font-family:BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif, 'Albert Sans';line-height:22px;font-weight:500;font-style:normal;font-size:14px;text-decoration:none;text-transform:none;letter-spacing:-0.56px;direction:ltr;color:#333333;text-align:center;mso-line-height-rule:exactly;mso-text-raise:2px;">
                                                            <b>Membro 10:</b> {{$data['nome10']}};</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <p class=t100
                                                            style="font-family:BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif, 'Albert Sans';line-height:22px;font-weight:500;font-style:normal;font-size:16px;text-decoration:none;text-transform:none;letter-spacing:-0.56px;direction:ltr;color:#333333;text-align:center;mso-line-height-rule:exactly;mso-text-raise:2px;">
                                                            Total para pagar na secretaria:<b> 300€</b></p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <p class=t250
                                                            style="font-family:BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif, 'Albert Sans';line-height:22px;font-weight:500;font-style:normal;font-size:14px;text-decoration:none;text-transform:none;letter-spacing:-0.56px;direction:ltr;color:#333333;text-align:left;mso-line-height-rule:exactly;mso-text-raise:2px;">
                                                            Alguma questão que tenhas envia-nos email, respondendo a
                                                            este email ou dirige-te à secretaria da AEIscte.</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                ...
                                <table class=t29 role=presentation cellpadding=0 cellspacing=0 align=center>
                                    <tr>
                                        ...
                                        <td class=t30 style="overflow:hidden;width:540px;padding:40px 30px 40px 30px;">
                                            <!--<![endif]-->
                                            <!--[if mso]><td style="overflow:hidden;width:600px;padding:40px 30px 40px 30px;"><![endif]-->
                                            <table role=presentation width=100% cellpadding=0 cellspacing=0>
                                                <tr>
                                                    <td>
                                                        <table class=t33 role=presentation cellpadding=0 cellspacing=0
                                                            align=center>
                                                            <tr>
                                                                <td class=t34 style="overflow:hidden;width:600px;">
                                                                    <p class=t40
                                                                        ...
                                                                        Acompanha as nossas redes sociais!</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class=t79
                                                                                            style="overflow:hidden;"><a
                                                                                                href=https://www.facebook.com/aeiscte/
                                                                                                style="font-size:0px;"><img
                                                                                                    class=t80
                                                                                                    style="display:block;border:0;height:auto;width:100%;Margin:0;max-width:100%;"
                                                                                                    width=24
                                                                                                    src=https://gala.aeiscte-iul.pt/img/3.png /></a>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </div>
                                                                            ...
                                                                            <div class=t67
                                                                                ...
                                                                                <table role=presentation width=100%
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class=t69
                                                                                            style="overflow:hidden;"><a
                                                                                                href=https://www.youtube.com/@AEISCTE
                                                                                                style="font-size:0px;"><img
                                                                                                    class=t70
                                                                                                    style="display:block;border:0;height:auto;width:100%;Margin:0;max-width:100%;"
                                                                                                    width=24
                                                                                                    src=https://gala.aeiscte-iul.pt/img/2.png /></a>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </div>
                                                                            ...
                                                                            <div class=t57
                                                                                ...
                                                                                <table role=presentation width=100%
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class=t59
                                                                                            style="overflow:hidden;"><a
                                                                                                href=https://www.instagram.com/aeiscte/
                                                                                                style="font-size:0px;"><img
                                                                                                    class=t60
                                                                                                    style="display:block;border:0;height:auto;width:100%;Margin:0;max-width:100%;"
                                                                                                    width=24
                                                                                                    src=https://gala.aeiscte-iul.pt/img/1.png /></a>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </div>
